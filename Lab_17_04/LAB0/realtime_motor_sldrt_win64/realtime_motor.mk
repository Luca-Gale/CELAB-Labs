...
MODEL                := realtime_motor
MODULES              := realtime_motor_data.c realtime_motor_tgtconn.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := realtime_motor.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := realtime_motor_ref.rsp
...
# additional includes
REQ_INCLUDES += ;$(WQ)D:/Lab_17_04_celab/LAB0$(WQ);$(WQ)D:/Lab_17_04_celab/LAB0/realtime_motor_sldrt_win64$(WQ);$(WQ)$(MATLAB_ROOT)/extern/include$(WQ);$(WQ)$(MATLAB_ROOT)/simulink/include$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src/ext_mode/common$(WQ);$(WQ)$(MATLAB_ROOT)/toolbox/coder/rtiostream/src$(WQ)
