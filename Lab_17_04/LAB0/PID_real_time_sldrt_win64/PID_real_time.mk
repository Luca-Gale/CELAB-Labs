...
MODEL                := PID_real_time
MODULES              := PID_real_time_data.c PID_real_time_tgtconn.c rt_nonfinite.c
MAKEFILE             := PID_real_time.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := PID_real_time_ref.rsp
...
# additional includes
REQ_INCLUDES += ;$(WQ)D:/Lab_17_04_celab/LAB0$(WQ);$(WQ)D:/Lab_17_04_celab/LAB0/PID_real_time_sldrt_win64$(WQ);$(WQ)$(MATLAB_ROOT)/extern/include$(WQ);$(WQ)$(MATLAB_ROOT)/simulink/include$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src/ext_mode/common$(WQ);$(WQ)$(MATLAB_ROOT)/toolbox/coder/rtiostream/src$(WQ)
