...
MODEL                := realtime_Euler_Pos_state_space
MODULES              := realtime_Euler_Pos_state_space_data.c realtime_Euler_Pos_state_space_tgtconn.c rt_nonfinite.c
MAKEFILE             := realtime_Euler_Pos_state_space.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := realtime_Euler_Pos_state_space_ref.rsp
...
# additional includes
REQ_INCLUDES += ;$(WQ)D:/Lab_17_04_celab/LAB2$(WQ);$(WQ)D:/Lab_17_04_celab/LAB2/realtime_Euler_Pos_state_space_sldrt_win64$(WQ);$(WQ)$(MATLAB_ROOT)/extern/include$(WQ);$(WQ)$(MATLAB_ROOT)/simulink/include$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src/ext_mode/common$(WQ);$(WQ)$(MATLAB_ROOT)/toolbox/coder/rtiostream/src$(WQ)
