...
MODEL                := Design2RealTime
MODULES              := Design2RealTime_data.c Design2RealTime_tgtconn.c rt_nonfinite.c
MAKEFILE             := Design2RealTime.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Design2RealTime_ref.rsp
...
# additional includes
REQ_INCLUDES += ;$(WQ)D:/Lab_17_04_celab/LAB2/DirectDigitalDesign$(WQ);$(WQ)D:/Lab_17_04_celab/LAB2/DirectDigitalDesign/Design2RealTime_sldrt_win64$(WQ);$(WQ)$(MATLAB_ROOT)/extern/include$(WQ);$(WQ)$(MATLAB_ROOT)/simulink/include$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src/ext_mode/common$(WQ);$(WQ)$(MATLAB_ROOT)/toolbox/coder/rtiostream/src$(WQ)
