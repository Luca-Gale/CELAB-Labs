...
MODEL                := Discrete_PID_realtime
MODULES              := Discrete_PID_realtime_data.c Discrete_PID_realtime_tgtconn.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := Discrete_PID_realtime.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Discrete_PID_realtime_ref.rsp
...
# additional includes
REQ_INCLUDES += ;$(WQ)D:/Lab_17_04_celab/LAB2$(WQ);$(WQ)D:/Lab_17_04_celab/LAB2/Discrete_PID_realtime_sldrt_win64$(WQ);$(WQ)$(MATLAB_ROOT)/extern/include$(WQ);$(WQ)$(MATLAB_ROOT)/simulink/include$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src/ext_mode/common$(WQ);$(WQ)$(MATLAB_ROOT)/toolbox/coder/rtiostream/src$(WQ)
