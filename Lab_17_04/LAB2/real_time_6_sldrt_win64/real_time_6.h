...
#ifndef real_time_6_h_
#define real_time_6_h_
#ifndef real_time_6_COMMON_INCLUDES_
#define real_time_6_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* real_time_6_COMMON_INCLUDES_ */

#include "real_time_6_types.h"
#include <stddef.h>
...
#define real_time_6_rtModel            RT_MODEL_real_time_6_T
...
#define rtB                            real_time_6_B
#define BlockIO                        B_real_time_6_T
#define rtP                            real_time_6_P
#define Parameters                     P_real_time_6_T
#define rtDWork                        real_time_6_DW
#define D_Work                         DW_real_time_6_T

/* Parameters (default storage) */
struct P_real_time_6_T_ {
  real_T AF;                           /* Variable: AF
                                        * Referenced by: '<Root>/Discrete State-Space2'
                                        */
  real_T BF[2];                        /* Variable: BF
                                        * Referenced by: '<Root>/Discrete State-Space2'
                                        */
  real_T CF[2];                        /* Variable: CF
                                        * Referenced by: '<Root>/Discrete State-Space2'
                                        */
  real_T K2[2];                        /* Variable: K2
  ...
  int32_T AnalogOutput_VoltRange;      /* Mask Parameter: AnalogOutput_VoltRange
                                        * Referenced by: '<Root>/Analog Output'
                                        */
  real_T Step3_Time;                   /* Expression: 0
  ...
  real_T DiscreteStateSpace2_InitialCondition;/* Expression: 0
                                               * Referenced by: '<Root>/Discrete State-Space2'
                                               */
  real_T pulse2deg3_Gain;              /* Expression: 0.18
                                        * Referenced by: '<Root>/pulse2deg3'
                                        */
  real_T Gain_Gain[2];                 /* Expression: [DF(3);DF(4)]
...
extern P_real_time_6_T real_time_6_P;

/* Block signals (default storage) */
extern B_real_time_6_T real_time_6_B;

/* Block states (default storage) */
extern DW_real_time_6_T real_time_6_DW;

/* Model entry point functions */
extern void real_time_6_initialize(void);
extern void real_time_6_output(void);
extern void real_time_6_update(void);
extern void real_time_6_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern real_time_6_rtModel *real_time_6(void);
...
extern RT_MODEL_real_time_6_T *const real_time_6_M;
 ...
 *
 * '<Root>' : 'real_time_6'
 * '<S1>'   : 'real_time_6/Subsystem5'
 */
#endif                                 /* real_time_6_h_ */
